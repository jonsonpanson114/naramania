...
const SEARCH_TARGETS = [
    ...
    },
    {
        ...
        label: '工事',
        // 「社会福祉総合センター本館トイレ改修工事」のような便所改修は、サイト側で
        // 建築一式(0000200)ではなく暖冷房衛生設備(0000900)に分類されることがあり、
        // 従来の2区分だけでは丸ごと検索対象から漏れていた。電気設備(0000800)は
        // 実データ確認の結果、浄水場・浄化センター等のインフラ設備のみで学校等の
        // 建築案件が無かったため対象に加えていない。
        gyoushuCodes: ['0000200', '0000900', '0001700'],
    },
];

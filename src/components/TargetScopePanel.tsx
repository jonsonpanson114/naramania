      ...
      <div className="grid gap-6 p-6 lg:grid-cols-[1fr_420px] lg:p-8">
        <div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-7 tracking-[0.04em] text-emerald-50/75">
            このサイトは、建築本体・設計監理・トイレ改修などを優先します。土木、道路、舗装、水道、設備、空調、照明、エレベーター系は対象外候補として監視し、一覧では初期表示から外します。
          </p>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-3">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/10 px-4 py-4">
              ...
              <p className="mt-1 text-xs text-emerald-50/55">土木・設備・EV など</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs leading-6 text-white/60">
                {hasNoise ? '一覧では初期非表示です。必要なら検索画面で表示を切り替えて確認できます。' : '現在の掲載データは、土木・設備・エレベーター系の除外判定を通過しています。'}
              </p>
            </div>
          </div>

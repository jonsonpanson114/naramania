...
const civilKws = ['土木', '舗装', '法面', '河川', '砂防', '造園', '水道', '管工', 'さく井', '橋梁', '除草', '草刈', '剪定', '下水道', '排水', '擁壁', '水路', '側溝', '堤防', '池', '林道', '農道', '防犯灯', '道路', '防護柵', '標識', '街路樹'];
...
console.log(`Reset intelligence for ${wipedCount} Nara Prefecture items.`);
